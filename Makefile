...
help:
	...
	@echo "  make spec-check     - Verify that every source citation in spec/ still resolves"
...
spec-check:
	@python3 support/dev/check-spec-citations.py
