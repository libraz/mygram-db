...
- [v1.9.0](v1.9.0.md) - Latest release (2026-07-27) - Search Surface Parity, Replication Fidelity & Correctness Hardening (HTTP/TCP shared parser, typed C/C++ search options, binlog value decoding, replication position state, in-place posting mutation, shared dump internals) ⚠️ BREAKING CHANGES
