...
- [v1.8.1](v1.8.1.md) - Latest release (2026-07-16) - Correctness & Reliability Hardening (snapshot/binlog position gap, SYNC integrity, MariaDB compressed events, DDL schema enforcement, fail-closed HTTP ACL, operation coordinator, process-wide reactor memory admission, ABI-safe C client/config additions)
