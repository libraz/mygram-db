...
- [v1.3.2](v1.3.2.md) - Latest release (2025-11-25) - Critical Binlog Parsing Fixes 🚨 URGENT UPGRADE (Replication Users)
- [v1.3.1](v1.3.1.md) - 2025-11-24 - Critical Bug Fixes 🚨 URGENT UPGRADE
