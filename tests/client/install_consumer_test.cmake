...
if(DEFINED MYGRAMDB_EXE_LINKER_FLAGS AND NOT "${MYGRAMDB_EXE_LINKER_FLAGS}" STREQUAL "")
  list(APPEND consumer_compiler_args "-DCMAKE_EXE_LINKER_FLAGS=${MYGRAMDB_EXE_LINKER_FLAGS}")
endif()
